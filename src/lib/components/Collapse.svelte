...
>
  <summary
    ...
    class:wcag-ui-collapse__header--icon-position-start={expandIconPosition === "start"}
...
<style>
  .wcag-ui-collapse {
    --wcag-ui-collapse-border-color: transparent;
  ...
  .wcag-ui-collapse[data-open="false"] {
  ...
  .wcag-ui-collapse__header--icon-position-start {
  ...
  .wcag-ui-collapse__header::marker {
    content: "";
  }
