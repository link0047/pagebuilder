...
<style>
  ...
  .wcag-ui-link:focus-visible {
    outline: var(--wcag-ui-link-outline-width) var(--wcag-ui-link-outline-style) var(--wcag-ui-link-outline-color);
